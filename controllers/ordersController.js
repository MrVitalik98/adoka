...
exports.makeInOrder = async (req,res) => {
   try{
        ...
        const session = await stripe.checkout.sessions.create({
            ...
            locale: 'en',
            mode: "payment",
            success_url: `${keys.BASE_URL}/orders/added_order`,
            cancel_url: `${keys.BASE_URL}/cart`,
        })
...
exports.paymentWithPaypal = async (req, res) => {
    ...
    "redirect_urls": {
        "return_url": `http://${keys.BASE_URL}/orders/added_order`,
        "cancel_url": `http://${keys.BASE_URL}/cart`
    },
    "transactions": [{
        "item_list": {
